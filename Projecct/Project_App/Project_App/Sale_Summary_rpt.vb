...
Public Class Sale_Summary_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Project_App.Sale_Summary_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSale_Summary_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Sale_Summary_rpt = New Sale_Summary_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
