    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            ...
            If ComboBox1.Text = "" And ComboBox2.Text = "" Then
                ...
                ds = d.loaddata("select D_Name, bill_Date, bill_No, Payment_Mode, bill_Total, GST_Total, Round_Off, L_SLIP from Purchase_summary where bill_Date between '" & DateTimePicker1.Value.ToString("dd-mm-yyyy") & "' and '" & DateTimePicker2.Value.ToString("dd-mm=yyyy") & "' ")

            ElseIf ComboBox1.Text <> "" And ComboBox2.Text = "" Then
                'All Customer Transection Between Date
                ds = d.loaddata("select D_Name, bill_Date, bill_No, Payment_Mode, bill_Total, GST_Total, Round_Off, L_SLIP from Purchase_summary where bill_Date between '" & DateTimePicker1.Value.ToString("dd-mm-yyyy") & "' and '" & DateTimePicker2.Value.ToString("dd-mm=yyyy") & "' and D_name = '" & ComboBox1.Text & "' ")

            ElseIf ComboBox1.Text = "" And ComboBox2.Text <> "" Then
                'All Payment Mode Transection Between Date
                ds = d.loaddata("select D_Name, bill_Date, bill_No, Payment_Mode, bill_Total, GST_Total, Round_Off, L_SLIP from Purchase_summary where bill_Date between '" & DateTimePicker1.Value.ToString("dd-mm-yyyy") & "' and '" & DateTimePicker2.Value.ToString("dd-mm=yyyy") & "' and Payment_Mode = '" & ComboBox2.Text & "' ")

            Else
                'All Transection Customer With Payment Mode

                ds = d.loaddata("select D_Name, bill_Date, bill_No, Payment_Mode, bill_Total, GST_Total, Round_Off, L_SLIP from Purchase_summary where bill_Date between '" & DateTimePicker1.Value.ToString("dd-mm-yyyy") & "' and '" & DateTimePicker2.Value.ToString("dd-mm=yyyy") & "' and Payment_Mode = '" & ComboBox2.Text & "' and D_name = '" & ComboBox1.Text & "'")

            End If

            DataGridView1.DataSource = ds.Tables(0)
            ds = d.loaddata("Select * from Purchase_Summary, Purchase_Details where purchase_summary.bill_no = purchase_details.bill_no")
