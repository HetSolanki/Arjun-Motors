...
Public Class Main_Page
    ...
    Private Sub Main_Page_Closed(sender As Object, e As EventArgs) Handles Me.Closed
    ...
    Private Sub Main_Page_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        ...
        Dim da As Integer = MessageBox.Show("Are you Sure to Exit Software", "Close", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
